...
from api.service.v1.upload_signature import upload_signature_insurant, upload_signature_beneficiary
...
upload_signature_api = Blueprint('upload-signature', __name__)
