...
from api.service.dev.information import (get_insurance_company_list, get_bank_company_list, get_hospital_info,
                                         get_work_list)
...
information_api = Blueprint('dev_information', __name__)
